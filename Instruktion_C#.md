...
данная команда имеет множество способов применения которые зависят от того что пишется после точки и случжит для работы/вывода информации в терминал(консоль)
